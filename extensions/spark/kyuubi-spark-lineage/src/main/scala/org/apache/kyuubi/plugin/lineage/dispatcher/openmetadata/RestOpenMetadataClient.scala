...
//
//import org.apache.kyuubi.plugin.lineage.dispatcher.openmetadata.api.VersionApi
...
//
//  private val versionApi: VersionApi = openMetadataGateway.buildClient(classOf[VersionApi])
//
//  override def getTableEntity(fullyQualifiedNameTemplate: String): Option[OpenMetadataEntity] = {
//    val version = versionApi.getCatalogVersion
//
//
